...
urlpatterns = [
    ...
    path('post/comments/<int:id>/',
         views.CommentView.as_view(), name='new_comment'),
    ...
    path('article/<slug:slug>/delete/',
         views.ArticleDelete.as_view(), name='article_delete'),
    path('article/<slug:slug>/update/',
         views.ArticleUpdate.as_view(), name='article_update'),
    ...
    path('category/<category>/', views.PostCategory.as_view(),
